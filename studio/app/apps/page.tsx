...
const getAppsWithStats = cache(async (): Promise<AppWithStats[]> => {
      ...
      <div className="grid gap-4 md:grid-cols-4">
        ...
        <div className="p-4 rounded-xl border border-white/5 bg-white/[0.02] backdrop-blur-xl">
          ...
          <p className="text-2xl font-bold mt-1">
            {appsWithStats.filter((t: AppWithStats) => t.isInternal).length}
          </p>
        </div>
        <div className="p-4 rounded-xl border border-white/5 bg-white/[0.02] backdrop-blur-xl">
          <p className="text-[10px] font-black uppercase tracking-widest text-white/30">
          ...
          <p className="text-2xl font-bold mt-1 text-green-500/80">
            {appsWithStats.filter((t: AppWithStats) => t.githubRepo).length}
          </p>
        </div>
        <div className="p-4 rounded-xl border border-white/5 bg-white/[0.02] backdrop-blur-xl">
          <p className="text-[10px] font-black uppercase tracking-widest text-white/30">
          ...
          <p className="text-2xl font-bold mt-1 text-blue-500/80">
            {appsWithStats.filter((t: AppWithStats) => t.vercelUrl).length}
          </p>
        </div>
      </div>
        ...
        <Table>
          ...
          <TableBody>
            {appsWithStats.length === 0 ? (
              ...
              appsWithStats.map((t: AppWithStats) => (
                <TableRow
                  key={t.id}
